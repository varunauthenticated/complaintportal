...
@Injectable()
export class ReportsDIDataService {
    ...
    getMISReportDetails(jsonBody: any) {
        this.actionUrl = AppUrlsConst.MIS_REPORT_DETAILS_URL;
    ...
    //method to get ref details by ref id
    //method to get complain reference details view
    getComplaintReferenceDetails(complaintReferenceNo: string) {
        this.actionUrl = AppUrlsConst.DI_COMPLAINT_REFERENCE_DETAILS_VIEW_WITHOUT_HEADER_URL + "/" + complaintReferenceNo + "/" + 0;
        this.headers = this.configService();
